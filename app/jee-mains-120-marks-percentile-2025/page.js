...
export default function Page() {
  ...
  return (
    <>
     ...
     <Head>
        {/* Primary Meta Tags */}
        <title>120 Marks in JEE Main 2026: Percentile & NIT Admission Chances</title>
        <meta
          name="description"
          content="Scored 120 in JEE Main 2026? Get your expected percentile (97-98) and AIR rank instantly. Check which NITs are available for 120 marks and if you qualify for JEE Advanced. Updated Jan Session data."
        />
        <link
          rel="canonical"
