      ...
      <section className="bg-blue-600 rounded-3xl p-1 text-center shadow-2xl shadow-blue-200">
        <div className="bg-blue-600 border-2 border-white/20 rounded-[1.4rem] p-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href={"/jee-main-college-cutoffs"}><button className="bg-blue-700 text-white px-8 py-4 hover:scale-105 transition-all duration-200 rounded-2xl font-black border border-blue-400 hover:bg-blue-800 cursor-pointer">
